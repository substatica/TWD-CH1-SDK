...
#include "UObject/NoExportTypes.h"
#include "SDISkinnedActor.generated.h"
...
class SDISKINPLUGIN_API ASDISkinnedActor : public AActor, public ISDISkinnedActorInterface, public ISDISkinnedActorBlueprintInterface {
    GENERATED_BODY()
public:
protected:
