...
#include "SDISkinnedActorStaticMesh.generated.h"
...
UCLASS()
class SDISKINPLUGIN_API ASDISkinnedActorStaticMesh : public AStaticMeshActor, public ISDISkinnedActorInterface, public ISDISkinnedActorBlueprintInterface {
    GENERATED_BODY()
public:
protected:
