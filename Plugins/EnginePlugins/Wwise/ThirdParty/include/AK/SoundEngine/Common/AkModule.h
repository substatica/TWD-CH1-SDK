...
struct AkMemSettings
{
	...
	AkMemDebugFalign				pfDebugFalign;					///< (Optional) Memory allocation debugging hook. Used for tracking calls to pfFalign.
	AkMemDebugCheckForOverwrite		pfDebugCheckForOverwrite;		///< (Optional) Memory allocation debugging hook. Used for detecting memory overwrites.
	//@}
